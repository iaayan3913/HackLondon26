  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50">
      ...
      <aside className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-60 bg-white border-r border-slate-200 flex flex-col p-4 z-40">
        ...
        <a href="#" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-100 hover:text-slate-800 transition-colors mb-1">
        ...
        <a href="#" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-semibold text-blue-600 bg-blue-50 mb-1">
          <svg className="w-5 h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
